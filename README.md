...
Computer engineering student interested in network security, machine learning, and building practical tools that solve real problems.

## What I Work On

- **Network Security**: Intrusion detection systems with explainable AI
- **Data Science**: NLP, sentiment analysis, classification pipelines
- **Automation**: PowerShell/Python scripts for sysadmin and IT operations
- **Web**: Interactive maps and graph algorithms
...
Python, PowerShell, JavaScript, scikit-learn, SHAP, Docker, Leaflet.js
